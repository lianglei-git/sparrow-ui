...
type ConfigurationChangedEvent = any
...
export class ViewConfigurationChangedEvent {
	...
	public hasChanged(id: any): boolean {
...
export class ViewRevealRangeRequestEvent {
	...
	public readonly scrollType: any;
	...
	constructor(source: string | null | undefined, range: Range | null, selections: Selection[] | null, verticalType: VerticalRevealType, revealHorizontal: boolean, scrollType: any) {
		this.source = source;
		this.range = range;
		this.selections = selections;
