...
export class Scrollable extends Disposable { // 核心逻辑
	...
	private _setState(newState: ScrollState, inSmoothScrolling: boolean): void {
		...
		// 这里发送一个 事件 告诉他们要更新了。
		// 最终接收到事件的地方在 src/vs/editor/browser/view/viewImpl.ts 这个文件里面的 handleEvents 这个方法上
